        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8 overflow-hidden">
            <div class="bg-white shadow-md hover:scale-105 transform duration-300 w-full max-w-sm mx-auto lg:mx-0">
                ...
                <div class="px-4 py-3">
                    ...
                    <span class="text-gray-400 uppercase text-sm">BRAND</span>
            ...
            <div class="bg-white shadow-md hover:scale-105 transform duration-300 w-full max-w-sm mx-auto lg:mx-0">
                <a href="">
                    <img class="object-cover w-full h-48 mt-3" src="../img/pict2.png" alt="Kijang Innova">
                </a>
                <div class="px-4 py-3">
                    <div class="flex items-center gap-2 mb-3 mt-2">
                        <span class="px-3 py-1 rounded-full text-xs bg-gray-100">stock ready</span>
            ...
            <div class="bg-white shadow-md hover:scale-105 transform duration-300 w-full max-w-sm mx-auto lg:mx-0">
                <a href="">
                    <img class="object-cover w-full h-48 mt-3" src="../img/pict2.png" alt="Civic">
                </a>
                <div class="px-4 py-3">
                    <div class="flex items-center gap-2 mb-3 mt-2">
                        <span class="px-3 py-1 rounded-full text-xs bg-gray-100">stock ready</span>
            ...
            <div class="bg-white shadow-md hover:scale-105 transform duration-300 w-full max-w-sm mx-auto lg:mx-0">
                <a href="">
                    <img class="object-cover w-full h-48 mt-3" src="../img/pict2.png" alt="Supra">
                </a>
                <div class="px-4 py-3">
                    <div class="flex items-center gap-2 mb-3 mt-2">
                        <span class="px-3 py-1 rounded-full text-xs bg-gray-100">stock ready</span>
