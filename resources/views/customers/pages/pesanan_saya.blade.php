            ...
            <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-sm leading-normal pl-6 bg-transparent border-b whitespace-nowrap shadow-transparent">
                  ...
                  @if ($pesanan->status == 'selesai')
                    <td class="px-3 py-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                        <button type="button" class="text-xs font-semibold leading-tight text-slate-400 viewPesanan" value="{{ $pesanan->id }}"> Hapus </button>
                    </td>
                  @endif
            ...
            <div class="modal-body">
              ...
              <div class="row my-4">
                ...
                <div class="col-sm-6 text-right">
                  <input name="kode" for="kode-pesanan-customers" id="kode-pesanan-customers"></input>
                </div>
              </div>
              <div class="row mb-2">
