    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
      ...
      <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        ...
        <div
          ...
          id="user-dropdown">
          <div class="px-4 py-3">
            <span class="block text-sm text-gray-900 dark:text-white">Just Feek Me</span>
            <span class="block text-sm  text-gray-500 truncate dark:text-gray-400">feekme18@gmail.com</span>
          </div>
