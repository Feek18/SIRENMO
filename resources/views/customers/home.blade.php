...
<body>
    ...
    <section
        ...
        <div class="px-4 mx-auto max-w-screen-xl text-center pt-24 lg:py-32">
            ...
            <div
                ...
                <button type="button"
                    class="text-white bg-color font-medium rounded-lg text-sm px-6 py-4 focus:outline-none">
                    <a href="">Search</a>
                </button>
            </div>
        </div>
    ...
    <section>
        <header class="container pt-14 p-8">
            <div class="flex flex-col justify-center items-center lg:flex lg:flex-row lg:justify-between lg:items-center space-x-2 rtl:space-x-reverse">
            ...
            <div class="lg:flex lg:flex-row lg:items-center lg:justify-center flex flex-col justify-center items-center gap-6 lg:gap-12 mt-14">
                <div class="card">
            ...
            <div class="lg:flex lg:flex-row lg:items-center lg:justify-center flex flex-col justify-center items-center gap-6 lg:gap-12 mt-6">
                <div class="card">
    ...
    <section>
        <header class="container pt-12 p-8">
            <div class="flex flex-col items-center justify-center lg:flex lg:flex-row lg:justify-between lg:items-center space-x-2 rtl:space-x-reverse">
                <div class="flex items-center space-x-2 rtl:space-x-reverse">
            ...
            <div class="lg:flex lg:flex-row lg:items-center lg:justify-around flex flex-col justify-center items-center gap-6 lg:gap-8 mt-14">
